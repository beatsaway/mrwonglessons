  ...
  const enModels = [
    {
      ...
      description: "Both works share floral subject matter, yet their treatment of media, line, and space creates two distinct style systems. Murakami's image is highly graphic and decorative, with flattened pictorial space and immediate visual readability. Chen Hongshou, by contrast, presents a literati mode in which controlled brush line and quieter spatial breathing produce a slower and more contemplative expression.",
      analysis: "In medium, Murakami's silkscreen process creates smooth, uniform color blocks and sharp edges, while Chen's ink-and-colour on silk shows absorbent transitions and varied brush trace. In line, Murakami relies on repeated contour for pattern and repetition, producing decorative rhythm; Chen varies brush pressure and speed, creating asymmetrical balance and softer tonal contrast. In space, Murakami compresses depth toward a frontal surface, whereas Chen uses blank intervals and layered flower-rock placement to suggest flexible pictorial distance.",
      interpretation: "Murakami's flower field can be read as a contemporary visual icon circulating in consumer-image culture, where brightness and repetition emphasize mass visibility. Chen's flower-and-rock pairing can be read as symbolic reflection on cultivated identity and moral restraint in classical painting culture. Together, the pair contrasts external spectacle with inward symbolic reading.",
      judgement: "Both are effective but for different reasons. Murakami is stronger in immediate impact, formal coherence, and recognizability. Chen is stronger in brush intelligence, cultural depth, and sustained interpretive resonance. A high-level evaluation should compare criteria explicitly and support claims with concrete visual evidence.",
    ...
    },
    {
      ...
      description: "Both works are landscape-related paintings, but the form language differs sharply. Mehretu constructs a layered and abstract field with dispersed marks and unstable orientation. Nash presents a surreal landscape with clearer motifs and staged spatial logic, creating a quieter but uncanny expression.",
      analysis: "Mehretu organizes line as directional traces across translucent layers, generating movement and distributed emphasis rather than one fixed focal point. The interrupted depth structure produces visual instability and a tense figure-ground relationship. Nash, in contrast, uses controlled object placement, measured spacing, and selective contrast to create balance and psychological stillness. The comparison shows one work pushing toward energetic fragmentation and the other toward symbolic composure.",
      interpretation: "Mehretu may be interpreted as visualizing systems in flux, migration, or contemporary uncertainty through non-literal space. Nash may be interpreted as a dreamlike meditation on memory, anxiety, and subconscious conflict, where landscape becomes a mental stage. Both works therefore transform landscape from description into meaning-bearing psychological space.",
    ...
    },
    {
      ...
      description: "Both works are installation-based 3D practice, yet they differ in scale and social orientation. Chen Shun-chu's piece is intimate, archival, and object-centered, while Althamer's installation is monumental and communal. Their expressions contrast private memory with collective social presence.",
    ...
    },
    {
      ...
      description: "Both works are highly stylized and visually seductive, but they operate through different media and formal systems. Shonibare presents figurative sculpture with symbolic material coding, while Hirst presents geometric print language with optical order and surface intensity.",
    ...
    },
    {
      ...
      judgement: "Hammershoi is stronger in atmospheric precision and spatial poetry. Botero is stronger in iconic style force and immediate legibility. Both are successful because formal decisions consistently support expressive intention.",
    ...
    },
    {
      ...
      interpretation: "Bruegel can be interpreted as close observation of social behavior, play, and communal order in daily life. The album leaf can be interpreted through literati symbolism, seasonal imagination, and cosmological poetics. Both use figurative imagery, but their cultural intentions and reading pace differ markedly.",
      judgement: "Bruegel is stronger in social density and narrative multiplicity, while the album leaf is stronger in lyrical compression and symbolic elegance. A high-mark response should explain how form and cultural context interact, rather than only listing visible differences.",
    ...
    },
    {
      ...
      description: "Both are large-scale 3D public works, yet they stage public space differently. Inges Idee emphasizes pathway, circulation, and environmental interaction, while Catalano emphasizes fragmented human presence and symbolic bodily absence.",
    ...
    },
    {
      ...
      description: "Both works engage botanical subject matter, but their formal approach differs in medium logic and viewing mode. Bosworth uses serial cyanotype on silk panels as a spatial sequence, while Reinagle/Stadler present a single-sheet colored aquatint with scientific illustrative clarity.",
      analysis: "Bosworth's hanging panels create transparency, rhythm, and movement across space as viewers shift position. Value changes are soft and process-visible, emphasizing trace over fixed contour. Reinagle/Stadler use precise line, centralized composition, and controlled contrast to stabilize observation and taxonomic reading. One work is process-and-space oriented; the other is image-and-description oriented.",
      interpretation: "Bosworth can be interpreted as a meditation on light memory, fragility, and temporal trace. Reinagle/Stadler can be interpreted within Enlightenment knowledge systems, where natural form is studied, classified, and aestheticized. Both works demonstrate how botanical imagery can carry different epistemic values.",
    ...
    },
    {
      ...
      description: "Both works depict human figures, but Wilson emphasizes social solidity and collective weight, while Hockney constructs a domestic portrait scene with observational distance and measured calm.",
      analysis: "Wilson organizes dark-light value structure, compact grouping, and dense form mass to create gravity and social tension. Hockney uses clearer interior space, controlled line, and balanced composition to articulate interpersonal distance and psychological quietness. The comparison shows two figure strategies: one compressive and forceful, one analytic and relational.",
      interpretation: "Wilson can be interpreted through labor, dignity, and class condition, where bodily mass conveys historical pressure. Hockney can be interpreted through family intimacy, generational gap, and modern domestic identity. Both works frame personhood, but with different emotional tempo and social register.",
    ...
    },
    {
      ...
      judgement: "High-level judgement should test whether each work links material decision to expressive purpose with consistency. Visual novelty alone is insufficient; evidence-based comparison of structure, meaning, and effect is required for top-band scoring.",
